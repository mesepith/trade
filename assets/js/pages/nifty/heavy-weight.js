...
$(document).on('click', '.sort_by_weightage', function () {
   
     var weightage_sortby = $(this).data('weightage-sortby');
//     alert(sector);
     
     $(".weightage_sortby").attr('name', 'weightage_sortby').attr('value', weightage_sortby);
