...
//        alert(e.target.value);
    ...
    if( $("#enable_to_date_chkbox").val() === 'yes' ){
        ...
        if(date_type=='from'){
            ...
            $('.sel_date_period').prop('checked', false);
...
$(".enable_to_date").change(function() {
    
    if( this.value == 'yes' ){
        
        $(".date_flat_pickz_to").attr('disabled','disabled');
        
        $(this).val('no');
        
    }else{
        
        $(".date_flat_pickz_to").removeAttr('disabled');
...
$(".sel_date_period").change(function() {
    ...
    if( $("#enable_to_date_chkbox").val() !== 'yes' ){
        ...
        $('#enable_to_date_chkbox').prop('checked', true); // Checks it
        $("#enable_to_date_chkbox").val('yes');
    }
