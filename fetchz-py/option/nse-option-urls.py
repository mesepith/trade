...
"""
#nse_option_functionz.checkStocksLiveTodayDataPresent()
...
d.get("https://www1.nseindia.com/live_market/dynaContent/live_watch/option_chain/optionKeys.jsp")
...
#                nse_option_functionz.getPutOptionTableData(d.current_url, company_id, company_symbol, dd_date_arr[each_dd_date_key] )
                nse_option_functionz.storePutCallUrl(d.current_url, company_id, company_symbol, dd_date_arr[each_dd_date_key] )
...
company_list = nse_option_functionz.companyListToFetchPCUrls()
