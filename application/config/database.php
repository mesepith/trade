...
//if($calledclass == 'PHPActiveRecord') $db['default']['dbdriver'] = 'mysql';
//else $db['default']['dbdriver'] = 'mysqli';
//
//$db['default']['dbprefix'] = '';
...
//
//if($calledclass != 'PHPActiveRecord'){
//	$CI =& get_instance();
//	$CI->load->database($db['default']);
//}

//echo '$calledclass : ' . $calledclass; exit;
