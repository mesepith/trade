...
if (!function_exists('normsdist')) {

    /*
     * @author: ZAHIR
     * DESC: normal distribution formula
     */
    ...
    function normsdist($x) {
        ...
        require PROJECT_DOCUMENT_ROOT . '/application/libraries/Math_Stats/normal_distribution/ndist_tabulated.php';
