...
<div class="container">
    <h2>Share Holding Company List</h2>  
    ...
    <table class="table table-striped" id="myTable">
        ...
        <tbody>
            ...
            <?php foreach ($company_list AS $company_list_value) { ?>
                ...
                <tr>
                    <td><a href="<?php echo base_url('shareholding/distrubution/' . $company_list_value->id . '/' . base64_url_encode($company_list_value->symbol) ); ?>">
