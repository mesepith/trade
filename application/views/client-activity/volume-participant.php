...
<div class="container">
    ...
    <h1>Volume Participant Wise Data</h1>
    
    <form method="get" action="<?php echo base_url('client-activity/volume-participant/'); ?>">
       ...
       <div class="row mb-60">
        ...
        <div class="mb-60">
            ...
            <div class="row">
                <div class="col-xl-1 col-12 mb-10">
                    <a href="<?php echo base_url() . 'volume-participant/cluster-return/Client'; ?>">Client</a>
                </div>
                <div class="col-xl-1 col-12 mb-10">
                    <a href="<?php echo base_url() . 'volume-participant/cluster-return/DII'; ?>">DII</a>
                </div>
                <div class="col-xl-1 col-12 mb-10">
                    <a href="<?php echo base_url() . 'volume-participant/cluster-return/FII'; ?>">FII</a>
                </div>
                <div class="col-xl-1 col-12 mb-10">
                    <a href="<?php echo base_url() . 'volume-participant/cluster-return/Pro'; ?>">Pro</a>
                </div>
            </div>
        </div>
            ...
            <tbody>
                ...
                <tr class="db_data">
                    ...
                    <td>
                        ...
                        <?php echo money_format('%!.0n', $oi_participant_data_value->option_index_call_long); 
